...
const Pengumuman = () => {
  ...
  return (
    <div className="relative overflow-hidden w-full h-screen">
      ...
      <div className=" top-0 left-0 right-0 flex justify-between items-center p-4">
        <button
      ...
      >
        {slides.map((slide, index) => (
          <div
            key={index}
            className="w-full h-[50vh] flex-shrink-0 flex flex-col items-center justify-center bg-cover bg-center"
      ...
      <div className=" bottom-0 left-0 right-0 flex justify-center items-center p-4 space-x-2">
        {slides.map((_, index) => (
          <div
            key={index}
