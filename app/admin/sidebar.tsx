        ...
        <ul className="space-y-2 font-medium">
          <li>
            ...
            >
              ...
              <span className="ms-3">Utama</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Class Info</span>
              {/* <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-[#495579] rounded-full dark:bg-gray-700 dark:text-gray-300">
                Pro
              </span> */}
            </Link>
          </li>
